...
const GoogleIcon = () => {
  return (
    <svg viewBox="0 0 24 24" className="size-4" aria-hidden="true">
      <path fill="#4285F4" d="M21.35 12.27c0-.68-.06-1.34-.17-1.97H12v3.73h5.23a4.47 4.47 0 0 1-1.94 2.93v2.44h3.14c1.84-1.69 2.92-4.18 2.92-7.13Z" />
      <path
        fill="#34A853"
...
const GoogleButton = () => {
  ...
  return (
    <Button type="button" variant="outline" className="h-11 w-full gap-3 bg-background font-medium cursor-pointer" onClick={handleGoogleLogin}>
      <GoogleIcon />
